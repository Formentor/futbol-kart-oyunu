...
export const QUESTIONS = [
  ...
  { id: 'S107', text: 'Hangi futbolcunun kariyer piyasa değeri zirvesi daha düşüktür?',                   field: 'peak_market_value_m',          higher_wins: false, unit: 'M€' },
  ...
  { id: 'S113', text: 'Hangi futbolcunun kariyerindeki en pahalı transferi daha düşüktür?',               field: 'highest_transfer_fee_m',       higher_wins: false, unit: 'M€' },
  ...
  { id: 'S118', text: 'Hangi futbolcu bir kulüpte daha kısa süre oynamıştır? (en uzun bağlılık)',         field: 'longest_club_tenure_years',    higher_wins: false, unit: 'yıl' },

  // ── HESAPLANMIŞ ORAN SORULARI ────────────────────────────────────────────────
  { id: 'S119', text: 'Hangi futbolcunun kariyer boyunca sezonda kazandığı kupa ortalaması daha yüksektir?', field: 'titles_per_season',         higher_wins: true,  unit: 'kupa/sn' },
  ...
  { id: 'S122', text: 'Hangi futbolcunun kariyer gollerinin daha büyük bir kısmı Şampiyonlar Ligi\'ndedir?', field: 'ucl_goal_ratio',            higher_wins: true,  unit: '%' },
  ...
  { id: 'S124', text: 'Hangi futbolcunun gollerinin daha büyük bir kısmı milli sahadadır?',               field: 'intl_goal_ratio',              higher_wins: true,  unit: '%' },
  { id: 'S125', text: 'Hangi futbolcunun vücut kitle endeksi (BMI) daha yüksektir?',                      field: 'bmi',                          higher_wins: true,  unit: 'kg/m²' },
  { id: 'S126', text: 'Hangi futbolcu kariyerinde daha hızlı kulüp değiştirmiştir? (yılda kulüp)',        field: 'clubs_per_year',               higher_wins: true,  unit: 'kulüp/yıl' },
  { id: 'S127', text: 'Hangi futbolcunun maç başına piyasa değeri (€) daha yüksektir?',                   field: 'value_per_game',               higher_wins: true,  unit: 'k€/maç' },
  { id: 'S128', text: 'Hangi futbolcunun kariyerinin daha büyük bir kısmı milli takımda geçmiştir?',      field: 'intl_ratio',                   higher_wins: true,  unit: '%' },
